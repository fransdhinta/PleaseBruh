...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      <li class="active"><a href="<?php echo site_url('guest')?>">Home</a></li>
      <li><a href="<?php echo site_url('guest/news')?>">News</a></li>      
    ...
    <ul class="nav navbar-nav navbar-right">
      ...
      <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">Blog <span class="caret"></span></a>
        <ul class="dropdown-menu">
          ...
          <li><a href="<?php echo site_url('guest/loginpage')?>">Logout</a></li>
        </ul>
       </li>
    </ul>   
  </div>
